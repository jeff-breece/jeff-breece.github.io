...
I could have skipped it. Plenty of people build the read-only version and stop, sensibly. But the ability to say "re-run the journal ingestion" while walking out of the room is useful, and I wanted to find out what it takes to do that responsibly rather than assume it can't be done.
...
Helen speaks through several channels and they have different constraints.
