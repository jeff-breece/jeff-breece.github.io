...
This needs an embedding model and nothing else, and embedding models are small. Not language-model small - far smaller. They run comfortably on a CPU, on a laptop, on hardware you'd otherwise call inadequate. The one here runs on every machine in the lab including the 4 GB ARM board.
