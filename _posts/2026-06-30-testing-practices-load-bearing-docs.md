...
If you're reading this with a secondhand laptop and a small model you downloaded last night, wondering whether that's enough to build anything real - it is. That's the whole thesis. Start with what's on the desk.
